...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title"><i class="fas fa-user-check"> Laporan Daftar Ulang</i></h4>
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-3">
                                <button type="submit" class="btn btn-primary"><i class="fas fa-search"></i>
                                    Tampilkan</button>
                                    <a href="{{ route('admin.daftar-ulang.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i>
                                        Kembali</a>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    {{-- PERBAIKAN: Mengambil nama dari relasi user, bukan biodata --}}
                                    <td>{{ $data->user->nama_lengkap ?? 'Siswa Dihapus' }}</td>
                                    <td>{{ $data->created_at->format('d M Y') }}</td>
                                    <td>{{ optional($data->jadwal)->nama_sesi ?? 'N/A' }}</td>
