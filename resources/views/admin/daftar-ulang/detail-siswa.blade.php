                                        ...
                                        <div class="col-md-6">
                                            <table class="table table-borderless table-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- Perbaikan: Menggunakan optional() untuk mencegah error jika
                                                    biodata null --}}
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- Perbaikan: Mengamankan kedua properti --}}
                                                    <td>: {{ optional($daftarUlang->user->biodata)->tempat_lahir ?? '-'
                                                        }}, {{ optional($daftarUlang->user->biodata)->tgl_lahir ?
                                                        \Carbon\Carbon::parse(optional($daftarUlang->user->biodata)->tgl_lahir)->format('d
                                                        M Y') : '-' }}</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="col-md-6">
                                            <table class="table table-borderless table-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- Perbaikan: Mengamankan relasi orangTua --}}
                                                    <td>: {{ optional($daftarUlang->user->orangTua)->nama_ibu ?? '-' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Email</strong></td>
                                                    <td>: {{ $daftarUlang->user->email ?? '-' }}</td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
