...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title"><i class="fas fa-plus"></i> Tambah Alur Pendaftaran</h4>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Form Tambah Langkah Alur Pendaftaran</div>
                    </div>

                    <form action="{{ route('admin.alur-pendaftaran.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="urutan" id="urutan"
                                        ...
                                        value="{{ old('urutan', ($maxUrutan ?? 0) + 1) }}" required>
                                </div>
                                @error('urutan')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">
                                    Masukkan nomor urutan langkah (1-20). Urutan selanjutnya: {{ ($maxUrutan ?? 0) + 1
                                    }}
                                </small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama" id="nama"
                                        ...
                                        placeholder="Contoh: Registrasi Akun" value="{{ old('nama') }}" required>
                                </div>
                                @error('nama')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="card-action">
                            <button type="submit" class="btn btn-success">
                                <i class="fa fa-check"></i> Simpan Langkah
                            </button>
            ...
            <div class="col-md-4">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div class="badge badge-primary badge-lg mb-2" id="preview-urutan">{{ ($maxUrutan ?? 0) + 1
                                }}</div>
                            <b> <h6 class="text-white mb-2 font-weight-bold" id="preview-nama">Nama Langkah</h6></b>
                            <p class="text-white small" id="preview-keterangan">Keterangan akan muncul di sini...</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-success">
                    <div class="card-header">
                        <div class="card-title">Langkah yang Sudah Ada</div>
                    </div>
                    <div class="card-body" style="max-height: 300px; overflow-y: auto;">
                        @foreach($existingSteps as $step)
                        <div class="d-flex align-items-center mb-2">
                            <span class="badge badge-primary me-2">{{ $step->urutan }}</span>
                            <small>{{ $step->nama }}</small>
                        </div>
                        @endforeach
                    </div>
                </div>
