{{-- resources/views/admin/pengumuman-hasil/create.blade.php --}}
@extends('layouts.admin.app')

@section('title', 'Buat Pengumuman Hasil SPMB')
@section('title_header_admin', 'Buat Pengumuman Hasil SPMB')

@section('admin_content')
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Buat Pengumuman Hasil</h4>
        <ul class="breadcrumbs">
            <li class="nav-home"><a href="{{ route('admin.dashboard') }}"><i class="flaticon-home"></i></a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="{{ route('admin.pengumuman-hasil.index') }}">Hasil SPMB</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a>Buat</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"><i class="fas fa-trophy me-2"></i>Form Pengumuman Hasil SPMB</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.pengumuman-hasil.store') }}" method="POST">
                        @csrf
                        <div class="form-group mb-3"><label for="judul" class="form-label fw-semibold">Judul <span
                                ...
                                value="{{ old('judul', 'Pengumuman Hasil Seleksi SPMB ' . date('Y')) }}"
                                required>@error('judul')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3"><label for="tanggal" class="form-label fw-semibold">Tanggal
                                        ...
                                        value="{{ old('tanggal', now()->format('Y-m-d\TH:i')) }}">@error('tanggal')<div
                        ...
                        <div class="form-group mb-3"><label for="isi" class="form-label fw-semibold">Isi Pengumuman
                                ...
                                required>{{ old('isi') }}</textarea>@error('isi')<div class="invalid-feedback">{{
                                $message }}</div>@enderror</div>
                        <div class="form-group mb-3">
                            <div class="form-check form-switch"><input class="form-check-input" type="checkbox"
                                    id="aktif" name="aktif" value="1" {{ old('aktif', true) ? 'checked' : '' }}><label
                                    class="form-check-label fw-semibold" for="aktif">Publikasikan Sekarang</label></div>
                        </div>
...
<script>
    $(document).ready(function() { $('#isi').summernote({ placeholder: 'Isi pengumuman hasil SPMB...', tabsize: 2, height: 300 }); });
</script>
@endpush
